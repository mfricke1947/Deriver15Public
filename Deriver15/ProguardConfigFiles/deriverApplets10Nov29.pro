-injars deriver10Applets.jar
-outjars deriver10AppletsOut.jar
...
# and setters.
-keep class us.softoption.hostApplets.*,us.softoption.gameApplets.*,us.softoption.interpretation.TInterpretationBoard,us.softoption.interpretation.TShape,us.softoption.interpretation.TBox,us.softoption.interpretation.TIndividual,us.softoption.interpretation.TProperty,us.softoption.interpretation.TRelation,us.softoption.interpretation.TFunction,us.softoption.interpretation.TIdentity,us.softoption.interpretation.TSemantics,us.softoption.proofwindow.TProofListModel,us.softoption.proofwindow.TProofline,us.softoption.parser.TFormula,us.softoption.editor2.TDocState,us.softoption.editor.TDocState {
    void set*(%);
    void set*(**);
    void set*(%[]);
    void set*(**[]);
...
# This is so that we can reset an Applet (by calling init() from 
# javascript
