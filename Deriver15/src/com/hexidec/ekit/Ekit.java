...
import javax.swing.JTextPane;  //mf

import us.softoption.editor.TDeriverApplication;   //mf
...
public class Ekit extends JFrame implements WindowListener
{
   ...
   public TDeriverApplication fApplication; //mf
...
public Ekit(TDeriverApplication anApplication){  //mf
              this();
 ...
 public EkitCore getEkitCore(){ //mf
   return
       ekitCore;
 }
 ...
 public JTextPane getTextPane()
        {
                return ekitCore.getTextPane(); //mf
        }
